...
class Point(object):
    ...
    def move_to(self, x, y):
        p_orig = Point(self.x, self.y)
        self.x = x
        self.y = y
        self.count += 1
        p = Point(self.x, self.y)
        self.total_dis += p_orig.get_distance_from(p)
    ...
    def get_distance_from_start(self):
        p = Point(self.orig_x, self.orig_y)
    ...
    def closer_to(self, p1, p2):
        dis1 = self.get_distance_from(p1)
        dis2 = self.get_distance_from(p2)
        if dis1 < dis2 or dis1 == dis2:
            return p1
        else:
            return p2
...
def run_test_repr():
    ...
    print('Expected for p1: Point(30, 999)')
    print('Actual for p1:  ', p1)
    print('Expected for p2: Point(34, 88)')
    print('Actual for p2:  ', p2)
...
def run_test_clone():
   ...
   """
    ...
    print('Expected for p1: Point(999, 333)')
    print('Actual for p1:  ', p1)
    print('Expected for p2: Point(1, 22)')
    print('Actual for p2:  ', p2)
    print('Expected for p3: Point(11, 22)')
    print('Actual for p3:  ', p3)
...
def run_test_move_to():
    ...
    p = Point(2, 5)
    print()
    print('Expected for p: Point(2, 5)')
    print('Actual for p:  ', p)
    p.move_to(50, 33)
    print('Expected for p: Point(50, 33)')
    print('Actual for p:  ', p)
...
def run_test_move_by():
    ...
    p.move_by(10, -3)
    print()
    print('Expected for p: Point(12, 1)')
    print('Actual for p:  ', p)
...
def run_test_get_number_of_moves_made():
    ...
    p.move_by(3, -2)
    print()
    print('Expected for p moves made: 2')
    print('Actual for p moves made:  ', p.get_number_of_moves_made())
...
def run_test_get_distance_from():
    ...
    p = Point(3, 5)
    print()
    print('Expected p to p1: 2.0')
    print('Actual   p to p1:', p.get_distance_from(p1))
...
def run_test_get_distance_from_start():
    ...
    p.move_to(8, 5)
    print()
    print('p from start to (5, 5), should be about 3.0')
    print('Actually is:', p.get_distance_from_start())
...
def run_test_get_distance_traveled():
    ...
    p.move_to(8, 8)
    print()
    print('Expected p has now traveled 12.0')
    print('Actual:', p.get_distance_traveled())
...
def run_test_closer_to():
    ...
    print()
    print('Expected:', p1)
    print('Actual:  ', p.closer_to(p1, p3))
...
def run_test_halfway_to():
    ...
    p = Point(4, 10)
    print()
    print('Should be: Point(4.0, 10.0)')
    print('Actual is:', p.halfway_to(p))
