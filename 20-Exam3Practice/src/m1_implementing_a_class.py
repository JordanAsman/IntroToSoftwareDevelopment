...
class Blob(object):
    ...
    def make_child(self, other_blob):
        ...
        Type hints:
          ...
          :rtype: Blob
        """
        child = Blob(self.color, other_blob.size)
        self.make_child_color = self.color
        return child
        # ---------------------------------------------------------------------
        # DONE: 6.
        #  a. READ specifications of this method (above).
    ...
    def get_distance(self, other_blob):
        ...
        Type hints:
          ...
          :rtype: float
        """
        pt1 = self.get_point(other_blob)
        pt2 = other_blob.get_point(self)
        return pt1.distance_from(pt2)
        # ---------------------------------------------------------------------
        # DONE: 8.
        #  a. READ specifications of this method (above).
        #     Also READ its tests (below) if you need additional clarification
    ...
    def swap_colors(self, other_blob):
        ...
        other_blob.color = original_color
        # ---------------------------------------------------------------------
        # DONE: 9.
        #  a. READ specifications of this method (above).
        #     Also READ its tests (below) if you need additional clarification
    ...
    def get_recent_color(self):
        ...
        """
        if self.make_child_color != None:
            return self.make_child_color
        else:
            return None
        # ---------------------------------------------------------------------
        # DONE: 10.
