...
def run_test_doubler():
    ...
    # -------------------------------------------------------------------------
    seq_of_lists = ([25, 13, 10], [5, 7], [-9, 4, 3, 5, 2, 4, 6], [12])

    # After the function call,  seq_of_lists  should be mutated to:
    expected_mutated = ([50, 26, 20], [10, 14], [-18, 8, 6, 10, 4, 8, 12], [24])
...
def run_test_zero_changer():
    ...
    # -------------------------------------------------------------------------
    tuple_of_lists = (
        [9, 7, 2, 0], [0, 3, 0, 12, 17, 1], [0, 5, 0], [4, 0, 7])

    # After the function call,  tuple_of_lists  should be mutated to:
    expected_mutated = (
        [9, 7, 2, 1], [2, 3, 3, 12, 17, 1], [4, 5, 5], [4, 6, 7])
