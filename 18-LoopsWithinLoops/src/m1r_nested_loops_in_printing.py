...
Authors: David Mutchler, Vibha Alangar, Matt Boutell, Dave Fisher,
         ...
         many others before them, and now Jordan Asman.
...
#           Example 1 has a longer inner loop than example 2. Example 2's
#           inner loop changes size each iteration, but example 1's does not
#  __
