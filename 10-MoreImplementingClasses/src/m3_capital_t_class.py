    ...
    *** See the PDFs, especially
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        *** See   03a-dimensions.pdf   to understand the following! ***
        ...
        center_x = intersection_center.x
        center_y = intersection_center.y
        upper_left_x1 = center_x - (width / 2)
        upper_left_y1 = center_y - (letter_thickness / 2)
        upper1 = rg.Point(upper_left_x1, upper_left_y1)
        lower_right_x1 = center_x + (width / 2)
        lower_right_y1 = center_y + (letter_thickness / 2)
        lower1 = rg.Point(lower_right_x1, lower_right_y1)
        self.h_rect = rg.Rectangle(upper1, lower1)
        # vertical rectangle
        upper_left_x2 = center_x - (letter_thickness / 2)
        upper_left_y2 = center_y - (letter_thickness / 2)
        upper2 = rg.Point(upper_left_x2, upper_left_y2)
        lower_right_x2 = center_x + (letter_thickness / 2)
        lower_right_y2 = center_y + (height - (letter_thickness / 2))
        lower2 = rg.Point(lower_right_x2, lower_right_y2)
        self.v_rect = rg.Rectangle(upper2, lower2)
        # ---------------------------------------------------------------------
        # DONE: 3.
