...
def sum_until_prime_input():
    ...
    sum = 0
    while True:
        number = int(input('Please enter an integer that is greater than 1: '))
        sum += number
        if is_prime(number):
            break
...
def run_test_sum_to_next_prime():
    ...
    print()
    print("TEST STARTED!  Has it ended?")
    expected = 12 + 13 # which is 25
    print_expected_result_of_test([12], expected, test_results, format_string)
    actual = sum_to_next_prime(12)
    print_actual_result_of_test(expected, actual, test_results)
    print("TEST ENDED!")
...
def run_test_wait_for_sum_of_cubes():
    ...
    print("TEST STARTED!  Has it ended?")
    expected = 3
    print_expected_result_of_test([30.33], expected, test_results, format_string)
    ...
    print("TEST STARTED!  Has it ended?")
    expected = 4
    print_expected_result_of_test([47], expected, test_results, format_string)
    actual = wait_for_sum_of_cubes(47)
    print_actual_result_of_test(expected, actual, test_results)
    print("TEST ENDED!")
