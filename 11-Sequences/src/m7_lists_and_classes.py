...
class ConceptMap:
    ...
    def number_of_small_circles(self, threshold):
        ...
        count = 0
        for k in range(len(self.circles)):
            if self.circles[k].radius < threshold:
                count += 1
        return count
        # ---------------------------------------------------------------------
    ...
    def product_of_sums_of_x_and_y_coordinates(self):
        ...
        sum = 1
        for k in range(len(self.circles)):
            sum = sum * (self.circles[k].center.x + self.circles[k].center.y)
        return sum
        # ---------------------------------------------------------------------
    ...
    def sum_of_some_indices(self):
        ...
        sum = 0
        for k in range(len(self.circles)):
            if self.circles[k].center.x > self.circles[k].center.y:
                sum += k
        return sum
        # ---------------------------------------------------------------------
    ...
    def product_of_some_radii(self):
        ...
        """
        product = 1
        for k in range(1, len(self.circles), 2):
             product *= self.circles[k].radius
        return product
        # ---------------------------------------------------------------------
    ...
    def sum_of_distances(self, point):
        ...
        sum = 0
        for k in range(len(self.circles)):
            sum += self.circles[k].center.distance_from(point)
        return sum
        # ---------------------------------------------------------------------
