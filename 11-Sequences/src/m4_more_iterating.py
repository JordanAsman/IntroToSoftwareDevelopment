...
def run_test_sum_sequence():
    ...
    expected_sum_from_probability_theory = sum(sequence6)
    expected_average_from_probability_theory = sum(sequence6) / len(sequence6)
...
def run_test_count_items_bigger_than():
    ...
    # DONE: 5 (continued):  Add your 2 ADDITIONAL tests here:

    # Test 9:
    sequence = [47, 80, 12, 7, -10, 95]
    threshold = 40
    expected = 3
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def run_test_count_positive_sines():
    ...
    # DONE: 7 (continued):  Add your 1 ADDITIONAL test here:

    # Test 11:
    expected = 1
    actual = count_positive_sines([3, 4, 5, 6])
    print()
...
def run_test_sum_first_n():
    ...
    # DONE: 9 (continued):  Add your 2 ADDITIONAL tests here:

    # Test 8:
    expected = 10
    actual = sum_first_n([20, -10, 5, 12], 2)
    print()
    print("Test 8 expected:", expected)
    print("       actual:  ", actual)
