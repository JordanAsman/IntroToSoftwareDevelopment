...
def run_test_problem3a():
    ...
    # Window 4:
    title = 'Problem 3a. Test 5: Start at (30, 30), 3 lines'
    window3 = rg.RoseWindow(450, 300, title)
...
def problem3a(window, point, n):
    ...
    shift_y = 10
    thick = 1
    line1 = rg.Line(point, rg.Point(point.x, point.y + 50))
    line1.thickness = thick
    line1.attach_to(window)
    for _ in range(n - 1):
        line = rg.Line(rg.Point(point.x + shift_x, point.y + shift_y), rg.Point(point.x + shift_x, (point.y + shift_y) + 50))
        point.x = point.x + shift_x
        point.y = point.y + shift_y
        if thick < 13:
            thick = thick + 2
...
def problem3b(m, point1):
    ...
    sum = 0
    for _ in range(m):
        sum = sum + problem3a(window, rg.Point(point1.x, point1.y), n)
        n = n + 2
