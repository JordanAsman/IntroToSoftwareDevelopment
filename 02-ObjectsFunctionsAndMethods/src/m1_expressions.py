...
print("25.2 - 18.8 evaluates to:  ", 25.2 - 18.8)
print("100 / 25 evaluates to:  ", 100 / 25)
...
print()
print("_TODO 6:")
print("(3 + 5) / 7 evaluates to:", (3 + 5) / 7)
print("(3 - 5) * 7 evaluates to:", (3 - 5) * 7)
print("(3 ** 5) + 7 evaluates to:", (3 ** 5) + 7)
...
# print("Python is silly and will cause an error for this!"
...
print()
print("_TODO 12:")
print(type(10 + (12 * 7) - 8))
print(type(10.0 + (12 * 7) - 8))
...
print("20 // 3    evaluations to:", 20 // 3)
print("20 % 3     evaluations to:", 20 % 3)
