...
def main():
    ...
    print(get_hypotenuse_length(3, 4))
    print("Should be 5")
    print(get_hypotenuse_length(12, 14))
    print("Should be about 18.44")

    turtleFunction("red", 10)
...
def get_hypotenuse_length(side1, side2):
...
def turtleFunction(color, thick):
    bill = rg.SimpleTurtle("turtle")
    bill.pen = rg.Pen("green", thick)
    ted = rg.SimpleTurtle("turtle")
    ted.pen = rg.Pen(color, 5)
    bill.forward(100)
    ted.backward(100)
