    ...
    while True:
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                bark_sound.play()
                # pygame.mixer.music.play() # Only has 1 music at a time (global music)
        ...
        caption2 = font2.render('Shhhh!', True, WHITE)
        screen.blit(caption2, (image1.get_width() // 2 - caption1.get_width() // 2, 0))
