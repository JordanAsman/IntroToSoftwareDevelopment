...
def run_test_count_cosines_from():
    ...
    # Test 3:
    expected = 4
    answer = count_cosines_from(5, 8, -0.5)
    print("Test 3 expected:", expected)
    print("       actual:  ", answer)

    # Test 4:
    expected = 2
    answer = count_cosines_from(2, 7, 0.38)
    print("Test 4 expected:", expected)
    print("       actual:  ", answer)

    # Test 5:
    expected = 1
    answer = count_cosines_from(0, 5, 0.90)
    print("Test 5 expected:", expected)
    print("       actual:  ", answer)

    # Test 6:
    expected = 3
    answer = count_cosines_from(3, 7, 0.23)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 3:
    expected = 1.217857143  # This is APPROXIMATELY the correct answer.
