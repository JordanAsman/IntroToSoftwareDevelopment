...
def run_test_make_simple_string():
    ...
    print("Expected:", expected)
    print("Actual:  ", make_simple_string(7, 13))

    # Test 2:
    expected = '5-6-7-8-9-10-11-12-'
    print("Expected:", expected)
    print("Actual:  ", make_simple_string(5, 12))
...
def run_test_make_less_simple_string():
    ...
    expected = '7-8-9-10-11-12-13'
    print("Expected:", expected)
    print("Actual:  ", make_less_simple_string(7, 13))

    # Test 2:
    expected = '5-6-7-8-9-10-11-12'
    print("Expected:", expected)
    print("Actual:  ", make_less_simple_string(5, 12))
...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        left = rg.Point(circles[k].center.x - circles[k].radius, circles[k].center.y - circles[k].radius)
        right = rg.Point(circles[k].center.x + circles[k].radius, circles[k].center.y + circles[k].radius)
